...
- Documents
- Email Imports
- Booking Detail query-param workspace (retired and consolidated into `render_dispatch_workspace`/`render_booking_workspace` in `pages_app/dispatch_board.py`; see later plan work)
...
pages_app/booking_detail.py  # retired; consolidated into pages_app/dispatch_board.py (render_dispatch_workspace/render_booking_workspace)
