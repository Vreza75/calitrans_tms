"""
Compatibility wrapper for older imports that expect database.db_client.
...
from utils.config import DOCUMENT_STORAGE_DIR, EDITABLE_COLUMNS, get_config_source, get_secret
