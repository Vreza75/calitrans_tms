"""Phase 7 closure (STEP 11/12): the live Operations Inbox "Sync Email
Engine" button must enqueue-and-return, not perform mailbox-wide
fetch/parse/classify/match/persist inline as part of normal page
execution.
