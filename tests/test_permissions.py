...
EXPECTED_MATRIX = {
    ...
    (Role.DISPATCHER, Permission.WORK_ITEM_MANAGE): True,
    ...
    (Role.ACCOUNTING, Permission.WORK_ITEM_MANAGE): False,
    ...
    (Role.MANAGER, Permission.WORK_ITEM_MANAGE): True,
    ...
    (Role.ADMIN, Permission.WORK_ITEM_MANAGE): True,
