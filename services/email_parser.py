...
LABEL_ALIASES = {
    ...
    "Warehouse": ["Warehouse", "New Delivery Warehouse", "Delivery Warehouse", "Delivery Location", "Deliver To", "Delivery To", "Destination", "Destination Location", "Consignee", "Loading At", "Load At"],
    "Address": ["Address", "New Delivery Address", "Delivery Address", "Warehouse Address", "Destination Address", "Consignee Address"],
...
def parse_email_text(subject: str | None = None, body: str | None = None, sender: str | None = None) -> dict[str, str]:
    ...
    if not parsed["TYPE"]:
        ...
        parsed["TYPE"] = normalize_service_flow(parsed["TYPE"], default=parsed["TYPE"])
